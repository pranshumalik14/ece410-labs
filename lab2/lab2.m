...
fprintf('To ensure the given calculations are right, we could check whether span_intersect is in span_sum, which should be true for any subspaces, i.e., V ∩ W must be in the image of V+W.\n')
...
% To find P, need to first determine W, that is the complement subspace of
% V
W = null(V');
