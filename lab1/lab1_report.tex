...
\begin{figure}[ht]
    ...
    \begin{minipage}[b]{0.45\textwidth}
        ...
        \captionof{figure}{state evolution for initial condition 1}    
    \end{minipage}
    \begin{minipage}[b]{0.45\textwidth}
        \centering
...
\begin{figure}[ht]
    ...
    \begin{minipage}[b]{0.45\textwidth}
        ...
        \captionof{figure}{state evolution for initial condition 2}    
    \end{minipage}
    \begin{minipage}[b]{0.45\textwidth}
        \centering
...
\begin{figure}[ht]
    ...
    \begin{minipage}[b]{0.45\textwidth}
        ...
        \captionof{figure}{Controlled State Evolution for $x_{0,1}$}    
    \end{minipage}
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        \includegraphics[clip,width=1\linewidth]{lab1/figs/section7_controlled_state_orbit_x_0_1.pdf}
        \captionof{figure}{Controlled State Orbit for $x_{0,1}$}
    \end{minipage}
\end{figure}
...
\begin{figure}[ht]
    ...
    \begin{minipage}[b]{0.45\textwidth}
        ...
        \captionof{figure}{Controlled State Evolution for $x_{0,2}$}    
    \end{minipage}
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        \includegraphics[clip,width=1\linewidth]{lab1/figs/section7_controlled_state_orbit_x_0_2.pdf}
        \captionof{figure}{Controlled State Orbit for $x_{0,2}$}
    \end{minipage}
\end{figure}
...
\begin{figure}[ht]
    ...
    \begin{minipage}[b]{0.45\textwidth}
        ...
        \captionof{figure}{Controlled State Evolution for $\theta = \pi/4$}    
    \end{minipage}
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        \includegraphics[clip,width=1\linewidth]{lab1/figs/section7_controlled_state_orbit_x_0_3.pdf}
        \captionof{figure}{Controlled State Orbit for $\theta = \pi/4$}
    \end{minipage}
\end{figure}
...
\begin{figure}[ht]
    ...
    \begin{minipage}[b]{0.45\textwidth}
        ...
        \captionof{figure}{Controlled State Evolution for $\theta = \pi/2$}    
    \end{minipage}
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        \includegraphics[clip,width=1\linewidth]{lab1/figs/section7_controlled_state_orbit_x_0_4.pdf}
        \captionof{figure}{Controlled State Orbit for $\theta = \pi/2$}
    \end{minipage}
\end{figure}
...
\begin{figure}[ht]
    ...
    \begin{minipage}[b]{0.45\textwidth}
        ...
        \captionof{figure}{Controlled State Evolution for $\theta = \pi$}    
    \end{minipage}
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        \includegraphics[clip,width=1\linewidth]{lab1/figs/section7_controlled_state_orbit_x_0_5.pdf}
        \captionof{figure}{Controlled State Orbit for $\theta = \pi$}
    \end{minipage}
\end{figure}
